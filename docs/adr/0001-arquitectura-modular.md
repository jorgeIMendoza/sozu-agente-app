...
- **Alcance:** `sozu-agente-app` (Flutter: web + Android + iOS). Este repo es la
  fuente de verdad del Portal del Agente; `sozu-admin` ya no se trabaja para
...
`sozu-agente-app` tiene hoy 85 archivos Dart / 44,075 LOC organizados por tipo
