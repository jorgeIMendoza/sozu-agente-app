...
> (`apps/sozu-agente-app`) sin romper la experiencia móvil existente.
...
```dart
/// Tokens del Portal del Agente web (espejo de .inmob-portal en sozu-admin).
class PortalColors {
...
| `PortalSidebar` | Sidebar.tsx | Fondo blanco, borde der. #E5E7EB; brand (logo 24px alto + "PORTAL DEL AGENTE" 10px ls1.8), nav, footer (avatar iniciales, Cerrar sesión rojo, versión mono 10px) |
