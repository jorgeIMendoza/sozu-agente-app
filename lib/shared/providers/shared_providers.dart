...
/// `features/agente/<hoja>/providers/`.
...
/// bloquea por fallo).
///
/// El fallo se imprime porque tragarlo entero ya costo caro en
/// sozu-cliente-app: la 1.0.3 llamaba a la function sin `Authorization`, el
/// gateway respondia 401 y el gate quedaba MUDO - ni aviso ni forzado - sin
/// ninguna senal de que estaba roto.
