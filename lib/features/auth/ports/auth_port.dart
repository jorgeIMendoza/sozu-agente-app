...
class UserProfile {
  ...
  /// el portal del cliente tiene `administrar_app_clientes` por historia, la app
  /// de agentes nace con el modelo nuevo y no arrastra ese flag.
  final bool canManageAgentApp;
