...
class ProfileAdapter implements ProfilePort {
  ...
  Future<ClientePerfil> profile() async =>
      ClientePerfil.fromJson(await _invoke('agente-perfil'));

  @override
  Future<PerfilCatalogos> catalogs() async => PerfilCatalogos.fromJson(
    await _invoke('agente-perfil', body: {'action': 'catalogos'}),
  );
  ...
  Future<void> deleteAvatar() async {
    await _invoke('agente-perfil', body: {'action': 'avatar_delete'});
  }
}
