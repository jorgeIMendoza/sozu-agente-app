...
import 'package:sozu_agente_app/features/agente/perfil/expediente/components/expediente_card.dart';
...
class _PerfilScreenState extends ConsumerState<PerfilScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final motorHero = ExpedienteCard(
      ...
      onGestionarDocumentos: () => context.push('/perfil/expediente'),
    );
          ...
          children: [
            ...
            if (p != null && completado < 85) ...[
              ...
              PerfilBannerCompletar(
                ...
                onCompletar: () => context.push('/perfil/expediente'),
              ),
            ],
          ],
        ),
