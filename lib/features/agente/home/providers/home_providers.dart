...
import 'package:sozu_agente_app/features/agente/home/adapters/home_adapter.dart';
...
final homePortProvider = Provider<HomePort>((ref) {
  ...
  return HomeAdapter(impersonate: imp.personaId);
});
...
/// Menú crudo de la BD (`cliente-menu`). NO lo consume la navegación: el
/// catálogo vive en código (`_portalNavItems`) y los permisos los resuelve
/// `agente-sesion` vía `menuAgenteProvider`. Se conserva el provider para no
/// rearmar el puerto si vuelve a hacer falta el listado tal cual.
