...
import 'package:sozu_agente_app/features/auth/components/login_form.dart';
...
/// solo - quien decide es `canManageAgentApp` del perfil.
void main() {
        ...
        .setMockMethodCallHandler(
          ...
          (call) async {
            ...
            return switch (args['key'] as String?) {
              'sozu_agente_biometria_habilitada' => 'true',
              'sozu_agente_biometria_user_id' => withUserId ? 'user-de-prueba' : null,
              'sozu_agente_biometria_refresh_token' =>
