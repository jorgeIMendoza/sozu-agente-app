...
- **El contador lo mueve SOLO quien publica a tiendas; la web lo LEE.** La web
  ...
  alcanzarían (pasó en sozu-cliente-app el 2026-08-13: web 1.0.5 contra Play
  1.0.4). El `X.Y.Z` identifica el RELEASE; los builds web intermedios se
  distinguen por el `-YYMMDD.HHMM` del mismo footer.
